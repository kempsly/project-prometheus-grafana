...
```export PYTHONPATH="/Users/Kempsly/Documents/packaging-ml-model-old-approach/ml-package/model-package:$PYTHONPATH"
...
4. Before installing, test whether you are able to import the package of `loan_predict_model` - (you should not be able to do it)
